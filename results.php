...
$stmt = $conn->prepare("
    ...
    WHERE ua.user_id = ?
      ...
      AND ua.submitted_at = (
          ...
          FROM user_answers sub
          WHERE sub.user_id = ua.user_id
            AND sub.question_id = ua.question_id
      )
...
// Add this to show attempt time
$latest_attempt = $answers ? $answers[0]['submitted_at'] : '';
?>
...
<strong>Latest Attempt:</strong> <?= htmlspecialchars($latest_attempt ?: 'N/A') ?><br>
